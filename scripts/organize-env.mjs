...
const lines = [
  ...
  "",
  "# Supabase — browser/auth do painel (valores públicos, mas limitados por RLS)",
  ...
  "# ============================================================================",
  "# Uso único por `npm run admin:create`; apague a senha após criar a conta.",
  `ADMIN_BOOTSTRAP_EMAIL=${raw("ADMIN_BOOTSTRAP_EMAIL")}`,
  `ADMIN_BOOTSTRAP_PASSWORD=${raw("ADMIN_BOOTSTRAP_PASSWORD")}`,
